		...
		if(isset($_GET['cari'])){
			$cari = $_GET['cari'];?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Hasil Pencarian: <?php echo $cari; ?></h1>
                <?php } ?>
                    <div class="row">	
			<?php 
				include "../koneksi.php";
				...
				<div class="col-md-4">
				  	<div class="card">
				    	...
				    	<div class="card-body">
				      		...
				      		<a href="edit.php?id=<?php echo $d['id_tutorial']; ?>" class="btn btn-primary">Edit</a>
				      		<a href="delete.php?id=<?php echo $d['id_tutorial']; ?>" class="btn btn-danger">Hapus</a>
				    	</div>
				  	</div>
				  	<br>
				</div>
